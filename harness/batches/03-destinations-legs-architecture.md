# Batch — Destinations & Travel Legs — Architecture
...
## Goal
Produce an implementation plan for Destinations & Travel Legs. No feature code.
...
## Allowed Files
- docs/implementation-plans/03-destinations-legs.md
- docs/adr/ADR-*.md

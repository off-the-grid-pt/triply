...
## Goal
Review and test Savings Plan against the approved spec. Do not silently repair implementation.
...
## Allowed Files
- e2e/savings.spec.ts
- src/features/savings/**/*.test.ts
- src/server/savings/**/*.test.ts
